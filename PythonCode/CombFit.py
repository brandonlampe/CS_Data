...
LOAD_START = 0.001  # DAYS
LOAD_END = 0.004  # DAYS
CREEP_START = 0.003  # START PLOTTING (days), IF NO ALTDOMAIN THEN FIT ALSO
CREEP_END = 0.845  # END PLOTTING (days), IF NO ALTDOMAIN THEN FIT ALSO

PCON_START = 0.0  # CONFINING PRESSURE AT START (MPa)
PPOR_START = 0

# define if/how many points shold be removed
LOAD_TRIM = 2  # NUMBER OF POINTS TO REMOVE FROM END
CREEP_TRIM = 3  # NUMBER OF POINTS TO REMOVE FROM BEGINNING
