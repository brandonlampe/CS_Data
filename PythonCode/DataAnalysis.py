...
STAGE_ID = '_STAGE26'  # '_STAGE01' , FOR MULTI-STAGE TESTS
...
DUR_START = 84.5  # START PLOTTING (days), IF NO ALTDOMAIN THEN FIT ALSO
DUR_END = 85.1  # END PLOTTING (days), IF NO ALTDOMAIN THEN FIT ALSO
