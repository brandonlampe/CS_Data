...
STAGE_ID = '_STAGE17'  # '_STAGE01' , FOR MULTI-STAGE TESTS
...
DUR_START = 20.38  # START PLOTTING (days), IF NO ALTDOMAIN THEN FIT ALSO
DUR_END = 22.0  # END PLOTTING (days), IF NO ALTDOMAIN THEN FIT ALSO
...
if SAVEFIG != 0:
    if PLOT_FITDATA == 1:
        FIG0.savefig(PATH + ADD_DIR + FIG0_NAME, bbox='tight')
    FIG1.savefig(PATH + ADD_DIR + FIG1_NAME)
