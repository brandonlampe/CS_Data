...
def column_idx(testname_str):
    ...
    if testname_str == '175_01':
        ...
        # col_fden = 29  # (Schuler 02) - FAILED at end of test
        ...
        col_ppor = 14  # pore pressure (psi)
        col_fden = 30  # calculated fractional density (Schuler AVG)
    elif testname_str == '175_13':
        col_time = 1  # Excel Time Column (days)
        col_temp = 8  # confining fluid temperature (C)
        col_pcon = 2  # confining pressure (psi)
        col_ppor = 14  # pore pressure (psi)
        # col_fden = 29  # calculated fractional density (Shu 02)
        col_fden = 30  # calculated fractional density (Schuler AVG)
        # col_fden = 31  # calculated fractional density (Sch Avg. & Shu 02)
    elif testname_str == '175_15':
        col_time = 1  # Excel Time Column (days)
        col_temp = 8  # confining fluid temperature (C)
        col_pcon = 2  # confining pressure (psi)
        col_ppor = 14  # pore pressure (psi)
        # col_fden = 28  # calculated fractional density (Shu 01)
        # col_fden = 29  # calculated fractional density (Shu 02)
        col_fden = 30  # calculated fractional density (Schuler AVG)
        # col_fden = 31  # calculated fractional density (Sch Avg. & Shu 02)
    elif testname_str == '175_16':
        col_time = 1  # Excel Time Column (days)
        col_temp = 8  # confining fluid temperature (C)
        col_pcon = 2  # confining pressure (psi)
        col_ppor = 14  # pore pressure (psi)
        ...
        # col_fden = 29  # calculated fractional density (Shu 02)
        col_fden = 30  # calculated fractional density (Schuler AVG)
        # col_fden = 31  # calculated fractional density (MANUAL EDIT)
        ...
        col_time = 1  # Excel Time Column (days)
        col_temp = 15  # confining fluid temperature (C)
        col_pcon = 41  # confining pressure (psi), modified when closed in
        col_ppor = 0  # pore pressure - none for this test
